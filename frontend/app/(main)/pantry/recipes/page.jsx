...
import { getRecipesByPantryIngredients } from "@/actions/recipes.actions";
...
const PantryRecipesPage = () => {
    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-6xl">
            <div className="mb-8">
                <Link href="/pantry" className = "inline-flex items-center gap-2 text-stone-600 hover:text-orange-600 transition-colors mb-4 font-medium">
                ...
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h1 className="text-4xl md:text-5xl font-bold text-stone-900 tracking-light">
                            What Can I Cook ?
                        </h1>
                ...
                {recipesData !== undefined && (
                    <div className="bg-orange-50 p-4 border-2 border-2 border-orange-200 inline-flex items-center gap-3">
            ...
            <div>
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-2">
                        ...
                        <Badge variant = "outline" className = "border-2 border-stone-900 font-bold uppercase tracking-wide">
                ...
                <div className="mt-8 text-center">
                    <Button onClick = {() => fetchSuggestions(new FormData())}
                    variant = "outline"
                    className = "border-2 border-stone-900 hover:bg-stone-900 hover:text-white gap-2" disabled={loading}>
                        {loading ? (
                            <>
        ...
        {!loading && recipesData == undefined && (
            <div className="bg-linear-to-br from-orange-50 to-amber-50 p-12 text-center">
