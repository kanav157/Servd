...
useEffect(() => {
    ...
    if (!recipeName)
    {
        ...
        <div className="container mx-auto max-w-4xl text-center py-20">
            ...
            <Link href = "/dashboard">
            <Button className = "bg-orange-600 hover:bg-ornange-700">
                Go to Dashboard
            </Button>
            </Link>
        </div>
        ...
        <div className="container mx-auto max-w-4xl">
            <div className="mb-8">
                ...
                <div className="bg-white p-8 md:p-10 border-2 border-stone-200 mb-6">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-stone-900 mb-4 tracking-light">
                        {recipe.title}
                    </h1>
...
<div className="flex flex-wrap gap-6 text-stone-600 mb-6">
            ...
            <div className="flex flex-wrap gap-3">
                ...
                className = {`${
                    ...
                    : "bg-orange-600 hover: bg-orange-700 border-2 borrder-orange-700"
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                <div className="lg:cols-span space-y-6">
                            ...
                            <div key={category} className="mb-6 last:mb-0">
                                ...
                                <ul className="space-y-2">
                                    {items.map((ingredient, i) => (
                                        <li 
                                        key = {i}
                                        className="flex justify-between itmes-start gap-2 text-stone-700 py-2 borer-b border-stone-100 last:border-0">
                                            <span className="flex-1">{ingredient.item}</span>
                                            <span className="font-bold text-orange-600 text-sm whitespacee-nowrap">
                                                {ingredient.amount}
                                            </span>
                                        </li>
                                    ))}
                    ...
                    {step.tip && (
                        <div className = "bg-orange-50 border-1-4 border-orange-600 p-4">
                            <p className="text-sm text-orange-900 flex items-start gap-2">
                                ...
                                <span>
                                    <strong className="font-bold">Pro Tips:</strong>
                                    {step.tip}
                                </span>
                            </p>
                            </div>
                        ...
                        <div className="mt-8 p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-orange-200">
